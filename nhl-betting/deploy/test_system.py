...
def test_kelly_sizer():
    ...
    print("  ✅ Kelly sizer produces reasonable bets for all strategies")
    return True
...
def test_notification_format():
    ...
    print("  ✅ Notification formats valid")
    return True
...
def test_database_connectivity():
    ...
    try:
        ...
        conn.close()
        print("  ✅ Database connected, all tables have data")
        return True
    except Exception as e:
...
def main():
    print("=" * 60)
    print("  NHL BETTING SYSTEM — END-TO-END TEST")
