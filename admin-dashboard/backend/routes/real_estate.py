...
async def list_il_foreclosures(
    ...
    """Return IL foreclosure listings with coordinates."""
    ...
    query = f"""
        SELECT id, source, case_number, address, city, county, zip,
               sale_date::text, sale_time, sale_type, opening_bid,
               judgment_amount, status, plaintiff, firm_name,
               auction_com_id, photo_url, lat, lng
